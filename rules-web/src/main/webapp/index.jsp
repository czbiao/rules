...
<nav
    ...
    <div class="container">
        <div class="menu-container page-scroll">
            <a class="navbar-brand" href="#body"> <img alt="韩山师范学院"
                                                       src="img/logo1.png">
            </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <div class="cr-left">
                        <p>
                            <strong>平台</strong>：韩山师范学院大学生网络安全知识竞赛
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
